...
public class TC_02_VerifyLoginFunctionality extends BaseTest 
{
	@Test(description = "TC_02_Verify Login Functionality", dataProvider="register",dataProviderClass=DataProviders.class)
