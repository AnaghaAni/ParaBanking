...
│       │   ├── tests/                  # Test classes
│       │   │   ├── BaseTest.java
│       │   │   ├── TC_01_Verify_New_User_Registration.java
│       │   │   ├── TC_02_VerifyLoginFunctionality.java
│       │   │   ├── TC_03_Verify_Fund_Transfer_Between_Accounts.java
│       │   │   ├── TC_04_Verify_Loan_Request.java
│       │   │   └── TC_05_Verify_Profile_Update.java
│       │   │
...
```bash
git clone https://github.com/AnaghaAni/ParaBanking.git
cd <ParaBank_UI>
```
